...
<@head_add_edit title="条码-新增"/>

    <@body_empty>
        <@form_padding title="新增条码">
            <@input label="预约" name="appointment" placeholder="请输入预约" require="false"/>
            <@input label="采血管" name="tube" placeholder="请输入采血管" require="false"/>
            <@input label="条形码" name="barcoding" placeholder="请输入条形码" require="false"/>
