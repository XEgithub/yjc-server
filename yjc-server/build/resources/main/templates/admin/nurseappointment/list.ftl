...
<script>
    layui.use(['element', 'table', 'form', 'layer'], function(){
        ...
        table.render({
            elem: '#myTable',
            id: 'myTable',
            url: '/admin/nurseappointment/list',
            method: 'post',
            ...
            cols: [[ //表头
                ...
                {field: 'status', title: '状态 0:派单中 1:已拒绝 2:已超时 3:用户取消 4:护士取消 5:已完成', sort: true},
        ...
        //新增弹窗
        <@table_add_plugin module="nurseappointment"/>
        //批量删除
        <@table_batch_delete_plugin module="nurseappointment"/>
        //表格搜索
        <@table_search_plugin/>
        //表格行操作按钮
        <@table_operator_plugin module="nurseappointment"/>
        //表格列排序
        <@table_sort_plugin/>
        //表格重载
        <@table_reload_plugin/>
