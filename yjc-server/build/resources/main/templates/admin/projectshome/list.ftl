    ...
    layui.use(['element', 'table', 'form', 'layer'], function(){
        ...
        table.render({
            ...
            cols: [[ //表头
                ...
                {field: 'classify', title: '分类uuid', sort: true},
        ...
        //新增弹窗
        <@table_add_plugin module="projectshome"/>
        //批量删除
        <@table_batch_delete_plugin module="projectshome"/>
        //表格搜索
        <@table_search_plugin/>
        //表格行操作按钮
        <@table_operator_plugin module="projectshome"/>
        //表格列排序
        <@table_sort_plugin/>
        //表格重载
        <@table_reload_plugin/>
