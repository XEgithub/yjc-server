    ...
    layui.use(['element', 'table', 'form', 'layer'], function(){
        ...
        table.render({
            ...
            cols: [[ //表头
                ...
                {field: 'searchName', title: '搜索关键字', sort: true},
                {field: 'count', title: '搜索次数', sort: true},
                {field: 'userId', title: '用户', sort: true},
                {field: 'createTime', title: '创建时间', sort: true},
                {field: 'updateTime', title: '修改时间', sort: true},
                {field: 'status', title: '0:不作为历史记录显示 1:作为历史记录显示', sort: true},
        ...
        //新增弹窗
        <@table_add_plugin module="searchhis"/>
        //批量删除
        <@table_batch_delete_plugin module="searchhis"/>
        //表格搜索
        <@table_search_plugin/>
        //表格行操作按钮
        <@table_operator_plugin module="searchhis"/>
        //表格列排序
        <@table_sort_plugin/>
        //表格重载
        <@table_reload_plugin/>
