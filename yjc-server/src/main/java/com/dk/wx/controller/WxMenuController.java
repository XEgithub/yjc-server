...
public class WxMenuController implements WxMpMenuService {
    ...
    @Override
    @PostMapping("/create")
    public String menuCreate(WxMenu menu1) throws WxErrorException {
        ...
        button11.setName("症状自查");
        button11.setUrl("https://wxclinic.pinganwj.com/weixin/guide/guideIndex.html");

        WxMenuButton button12 = new WxMenuButton();
        button12.setType(MenuButtonType.VIEW);
        button12.setName("快速问诊");
        button12.setUrl("https://weixin.chunyuyisheng.com/cooperation/wap/weixin/login/?partner=huayanwuyou");

        WxMenuButton button13 = new WxMenuButton();
        button13.setType(MenuButtonType.VIEW);
        button13.setName("预约挂号");
        button13.setUrl("http://www.jiankangchou.cn");

        WxMenuButton button14 = new WxMenuButton();
        button14.setType(MenuButtonType.VIEW);
        button14.setName("陪诊陪护");
        button14.setUrl("http://www.soso.com/");

        WxMenuButton button15 = new WxMenuButton();
        button15.setType(MenuButtonType.VIEW);
        button15.setName("跑腿待办");
        button15.setUrl("http://www.jiankangchou.cn/com.dk.it/ptdb/index.html");
        ...
        button21.setName("上门采样");

        String url = wxService.oauth2buildAuthorizationUrl("http://www.jiankangchou.cn/com.dk.it/smcy/index.html", WxConsts.OAuth2Scope.SNSAPI_USERINFO, null);
//        button21.setUrl("http://hywy.ngrok.sourcespro.cn/wx/home");
        button21.setUrl("http://www.jiankangchou.cn/wx/home");

        WxMenuButton button22 = new WxMenuButton();
        button22.setType(MenuButtonType.VIEW);
        button22.setName("医院检查");
//        button22.setUrl("http://www.soso.com/");
        String url2 = wxService.oauth2buildAuthorizationUrl("http://www.jiankangchou.cn/order/create", WxConsts.OAuth2Scope.SNSAPI_USERINFO, null);
        button22.setUrl(url2);

        WxMenuButton button23 = new WxMenuButton();
        button23.setType(MenuButtonType.VIEW);
        button23.setName("报告服务");
        button23.setUrl("http://www.jiankangchou.cn/com.dk.it/bgfw/bgfw.html");
        ...
        button33.setName("就医记录");
        button33.setUrl("http://www.soso.com/");

        WxMenuButton button34 = new WxMenuButton();
        button34.setType(MenuButtonType.VIEW);
        button34.setName("领优惠券");
        button34.setUrl("http://www.soso.com/");

        WxMenuButton button35 = new WxMenuButton();
        button35.setType(MenuButtonType.VIEW);
        button35.setName("推广联盟");
        button35.setUrl("https://v.qq.com/");
