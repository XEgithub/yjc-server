    ...
    layui.use(['element', 'table', 'form', 'layer'], function(){
        ...
        table.render({
            ...
            cols: [[ //表头
                ...
                {field: 'wxUser', title: 'wx_userUuid', sort: true},
                {field: 'image', title: '头像', sort: true},
                ...
                {field: 'identity', title: '身份', sort: true},
        ...
        //新增弹窗
        <@table_add_plugin module="wxuserextend"/>
        //批量删除
        <@table_batch_delete_plugin module="wxuserextend"/>
        //表格搜索
        <@table_search_plugin/>
        //表格行操作按钮
        <@table_operator_plugin module="wxuserextend"/>
        //表格列排序
        <@table_sort_plugin/>
        //表格重载
        <@table_reload_plugin/>
