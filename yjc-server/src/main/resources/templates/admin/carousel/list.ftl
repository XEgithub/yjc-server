    ...
    layui.use(['element', 'table', 'form', 'layer'], function(){
        ...
        table.render({
            ...
            cols: [[ //表头
                ...
                {field: 'alone', title: '0:轮播图 1:固定显示图', sort: true},
                {field: 'createTime', title: '创建时间', sort: true},
                {field: 'updateTime', title: '修改时间', sort: true},
                {field: 'operator', title: '操作人', sort: true},
                {field: 'status', title: '0:禁用 1:启用', sort: true},
        ...
        //新增弹窗
        <@table_add_plugin module="carousel"/>
        //批量删除
        <@table_batch_delete_plugin module="carousel"/>
        //表格搜索
        <@table_search_plugin/>
        //表格行操作按钮
        <@table_operator_plugin module="carousel"/>
        //表格列排序
        <@table_sort_plugin/>
        //表格重载
        <@table_reload_plugin/>
